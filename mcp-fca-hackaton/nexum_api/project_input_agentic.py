...
_SUPPLY_CLASS_HINTS: list[tuple[str, set[str]]] = [
    ...
    ("electrical_feeder", {"cableado", "awg", "tableros de distribucion", "tableros de distribución", "ducto pvc", "ducto"}),
    ...
    ("tile_finish", {"tablon", "tablón", "baldosa", "baldosas", "porcelanato", "ceramica", "cerámica"}),
    ("door", {"puerta", "puertas"}),
