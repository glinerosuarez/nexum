...
ENV_VARS="${ENV_VARS},SUPPLY_AGENT_ORCHESTRATOR=${SUPPLY_AGENT_ORCHESTRATOR},AGENT_BUILDER_PROJECT_ID=${AGENT_BUILDER_PROJECT_ID},AGENT_BUILDER_LOCATION=${AGENT_BUILDER_LOCATION},AGENT_BUILDER_MODEL=${AGENT_BUILDER_MODEL}"
