...
AGENT_BUILDER_ENABLED="${AGENT_BUILDER_ENABLED:-false}"
...
ENV_VARS="${ENV_VARS},AGENT_BUILDER_ENABLED=${AGENT_BUILDER_ENABLED},AGENT_BUILDER_PROJECT_ID=${AGENT_BUILDER_PROJECT_ID},AGENT_BUILDER_LOCATION=${AGENT_BUILDER_LOCATION},AGENT_BUILDER_MODEL=${AGENT_BUILDER_MODEL}"
