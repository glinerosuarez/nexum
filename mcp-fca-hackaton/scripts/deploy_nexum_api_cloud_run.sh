...
SUPPLY_AGENT_ORCHESTRATOR="${SUPPLY_AGENT_ORCHESTRATOR:-adk}"
AGENT_BUILDER_PROJECT_ID="${AGENT_BUILDER_PROJECT_ID:-${VERTEX_PROJECT_ID:-$PROJECT_ID}}"
AGENT_BUILDER_LOCATION="${AGENT_BUILDER_LOCATION:-${VERTEX_LOCATION:-$REGION}}"
AGENT_BUILDER_MODEL="${AGENT_BUILDER_MODEL:-${VERTEX_MODEL:-gemini-2.5-flash}}"
...
ENV_VARS="${ENV_VARS},SUPPLY_AGENT_ORCHESTRATOR=${SUPPLY_AGENT_ORCHESTRATOR},AGENT_BUILDER_PROJECT_ID=${AGENT_BUILDER_PROJECT_ID},AGENT_BUILDER_LOCATION=${AGENT_BUILDER_LOCATION},AGENT_BUILDER_MODEL=${AGENT_BUILDER_MODEL},GOOGLE_GENAI_USE_VERTEXAI=true,GOOGLE_CLOUD_PROJECT=${AGENT_BUILDER_PROJECT_ID},GOOGLE_CLOUD_LOCATION=${AGENT_BUILDER_LOCATION}"
